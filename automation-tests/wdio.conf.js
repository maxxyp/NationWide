// var baseUrl = 'http://www.webdriveruniversity.com';      //create a baseUrl using camel case...
var baseUrl = 'https://www.nationwide.co.uk';
...
exports.config = {
    ...
    exclude: [
        './src/tests/pages/**/*._Pages.js',

        './src/tests/features/**/**/*.js',
     ...
     */
     beforeSession: function (config, capabilities, specs) {
      ...
      //del(['allure-report', 'reports']);
        del(['allure-results', 'json-reports', 'junit-reports', 'ERROR-chrome-*.png']);
     },
    /**
